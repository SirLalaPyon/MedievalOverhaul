...
{
	public class DeathActionWorker_PlainchratSplit : DeathActionWorker
	{
        ...
        public override void PawnDied(Corpse corpse, Lord prevLord)
		{
			if (corpse.Map != null)
			{
                ...
                for (int i = 0; i < range; i++)
				{
                    ...
                    Pawn pawn = PawnGenerator.GeneratePawn(MedievalOverhaulDefOf.DankPyon_SchratPlain_Sapling);
